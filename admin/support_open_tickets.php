...
<head>
    ...
    <title>Open Support Tickets - ManuelCode</title>
        ...
        <aside id="sidebar" class="sidebar-transition fixed lg:sticky top-0 left-0 z-50 w-64 bg-[#2D3E50] text-white transform -translate-x-full lg:translate-x-0 lg:flex lg:flex-col h-screen">
            ...
            <div class="flex-1 overflow-y-auto scrollbar-hide">
                <nav class="mt-4 px-2 pb-4">
                    ...
                    <a href="support_open_tickets.php" class="flex items-center py-3 px-4 bg-[#243646] rounded-lg mb-2 transition-colors w-full">
        ...
        <div class="flex-1 lg:ml-0 min-h-screen">
            ...
            <header class="hidden lg:block bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-[#2D3E50]">Open Support Tickets</h1>
                        <p class="text-gray-600 mt-1">Review and respond to new support requests</p>
                    </div>
            ...
            <header class="lg:hidden bg-white shadow-sm border-b border-gray-200 p-4">
                <div class="flex items-center justify-between">
                    ...
                    <h1 class="font-semibold text-gray-800">Open Support Tickets</h1>
                    <div class="w-8"></div>
                </div>
            </header>
            ...
            <main class="px-6 py-8">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100">
                    <div class="px-4 lg:px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <h2 class="text-lg lg:text-xl font-semibold text-[#2D3E50]">Open Tickets (<?php echo $total_tickets; ?>)</h2>
                            <div class="flex space-x-2">
                                ...
                                <a href="support_closed_tickets.php" class="inline-flex items-center px-3 py-2 bg-green-500 text-white text-sm rounded-lg hover:bg-green-600 transition-colors">
                                    <i class="fas fa-check-circle mr-2"></i>Closed Tickets
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="p-4 lg:p-6">
                                ...
                                <table class="w-full">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-3 lg:px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Priority</th>
                        ...
                        <?php else: ?>
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-600">No open tickets found.</p>
                                <p class="text-sm text-gray-500 mt-1">All support tickets have been responded to!</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
