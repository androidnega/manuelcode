...
<head>
    ...
    <title>All Support Tickets - ManuelCode</title>
        ...
        <aside id="sidebar" class="sidebar-transition fixed lg:sticky top-0 left-0 z-50 w-64 bg-[#2D3E50] text-white transform -translate-x-full lg:translate-x-0 lg:flex lg:flex-col h-screen">
            ...
            <div class="flex-1 overflow-y-auto scrollbar-hide">
                <nav class="mt-4 px-2 pb-4">
                    ...
                    <a href="support_tickets.php" class="flex items-center py-3 px-4 bg-[#243646] rounded-lg mb-2 transition-colors w-full">
        ...
        <div class="flex-1 lg:ml-0 min-h-screen">
            ...
            <header class="hidden lg:block bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-[#2D3E50]">All Support Tickets</h1>
                        <p class="text-gray-600 mt-1">View and manage all support tickets</p>
                    </div>
            ...
            <header class="lg:hidden bg-white shadow-sm border-b border-gray-200 p-4">
                <div class="flex items-center justify-between">
                    ...
                    <h1 class="font-semibold text-gray-800">All Support Tickets</h1>
                    <div class="w-8"></div>
                </div>
            </header>
            ...
            <main class="px-6 py-8">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100">
                    <div class="px-4 lg:px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <h2 class="text-lg lg:text-xl font-semibold text-[#2D3E50]">All Tickets (<?php echo $total_tickets; ?>)</h2>
