...
if (!defined('ROUTER_INCLUDED') && !isset($_SERVER['HTTP_X_ROUTER'])) {
    ...
    header('Location: ' . $protocol . '://' . $host . '/dashboard/refunds');
    exit;
}
  ...
  <div class="flex">
     ...
     <aside id="sidebar" class="sidebar-transition fixed lg:sticky top-0 left-0 z-50 w-64 <?php echo $dark_mode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'; ?> border-r transform -translate-x-full lg:translate-x-0 lg:flex lg:flex-col h-screen">
      ...
      <div class="flex-1 overflow-y-auto scrollbar-hide">
           ...
           <a href="/dashboard" class="flex items-center py-3 px-4 <?php echo $dark_mode ? 'text-gray-300 hover:bg-gray-800' : 'text-gray-700 hover:bg-gray-50'; ?> rounded-lg mb-2 transition-colors w-full">
